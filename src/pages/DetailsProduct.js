...
export default function DetailsProduct() {
  ...
  return (
    <div className="min-h-screen bg-zinc-100 flex flex-col items-center">
      ...
      className="transition-all duration-200 mr-2 ml-auto mt-4 flex items-center bg-orange-300 hover:bg-orange-400 p-2 rounded-full"><MdOutlineArrowBackIosNew /></button>
      {product && (
